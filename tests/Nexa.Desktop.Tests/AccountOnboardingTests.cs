...
internal static partial class Program
{
    ...
    {
        AccountOnboardingOptions packaged = Nexa.Desktop.Program.MergeAccountOnboardingOptions(
        ...
        AccountOnboardingOptions overridden = Nexa.Desktop.Program.MergeAccountOnboardingOptions(
    ...
    private static void AccountFailuresAndLateFilePickerStayInCurrentView()
    {
        ...
        AssertTrue(AccountSnapshot(fixture).Message.Contains("NEXA_MS_CLIENT_ID", StringComparison.Ordinal));
