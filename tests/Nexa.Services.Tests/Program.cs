...
internal static partial class Program
{
    ...
    [
        ...
        ("exclusive recovery excludes operations and allows existing nested work", RecoveryRestoreExcludesOperationsWithoutDeadlockingNestedWork),
        ("exclusive recovery cancellation releases waiters", RecoveryRestoreCancellationReleasesWaitersAndYieldsCapture),
        ("install waits for exclusive recovery before writing", InstallWaitsForExclusiveRecoveryBeforeWriting),
        ...
        ("rename journal resumes every interrupted prefix and rolls back", RenameJournalResumesEveryInterruptedPrefixAndRollsBack),
        ("rename only pending install resumes without reinstalling", RenameOnlyPendingInstallResumesWithoutReinstalling),
        ("component publication and rename recover as one task", ComponentPublicationAndRenameRecoverAsOneTask),
        ...
        ("mod categories distinguish problems unknown and verified updates", ModCategoriesDistinguishProblemsUnknownAndVerifiedUpdates),
        ...
        ("content removal is recoverable and rejects conflicts", ContentRemovalIsRecoverableAndRejectsConflicts),
        ...
        ("modpack recovery uses pinned archive and verified downloads", ModpackRecoveryUsesPinnedArchiveAndReusesVerifiedDownloads),
        ("modpack publication recovers lost completion and protects changed files", ModpackPublicationRecoversLostCompletionAndProtectsChangedFiles),
        ("cancel queued modpack prevents startup recovery", CancelQueuedModpackPreventsStartupRecovery),
