...
internal static partial class Program
{
    ...
    internal static void MinecraftDownloadPlannersRespectExistingFiles()
    {
        ...
        Nexa.Services.Minecraft.Downloads.MinecraftAssetDownloadPlan skipped = MinecraftAssetDownloadPlanner.CreatePlan(new MinecraftAssetDownloadPlanRequest
        {
            Assets = [asset],
        ...
        Nexa.Services.Minecraft.Downloads.MinecraftAssetDownloadPlan forced = MinecraftAssetDownloadPlanner.CreatePlan(new MinecraftAssetDownloadPlanRequest { Assets = [asset], CheckHash = true });
    ...
    internal static async ValueTask MinecraftJavaRuntimeInstallerVerifiesAndInstalls()
    {
        ...
        try
        {
            ...
            Nexa.Services.Logging.LogService log = CreateLogService();
