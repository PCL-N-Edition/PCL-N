...
public sealed class DesktopArchitectureTests
{
    ...
    public void DesktopSettings_UsesGeneratedStaticRegistry()
    {
        ...
        Assert.AreEqual(12, CountOccurrences(registrySource, "[SetupPage("));
    ...
    public void ReleaseWorkflowsPublishAvaloniaForEveryDesktopRuntime()
    {
        ...
        // CI rolling channel is Windows portable only (scatter cannot use CI).
        StringAssert.Contains(ci, "PCL_N_CI_win-(x64|arm64)_SelfContained_Portable");
        StringAssert.Contains(ci, "Skip non-Windows CI artifact for rolling channel");
