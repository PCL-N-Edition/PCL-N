...
For example, XSR product `2.0.0.beta.1` may validate Plugin SDK `1.0.0-rc.1` and Sidecar Protocol v1. A product release never implies that an unrelated public contract has the same major number.
