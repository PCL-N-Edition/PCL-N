...
- The loader is a static mapping over closed IR data: no reflection, no runtime XML parsing, no property-path evaluation. `Nexa.Pxml.Runtime` references the compiler for the IR types — the dependency direction stays acyclic.
