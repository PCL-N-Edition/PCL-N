...
public sealed class MinecraftVersionDiscovery(Nexa.Services.Logging.LogService? log = null)
{
        ...
        string minecraftRootDirectory, CancellationToken cancellationToken)
    {
        ...
        {
            log?.Write(Nexa.Services.Logging.LogLevel.Warn, "VersionScan", $"Version enumeration failed directory={versionsDirectory}", Nexa.Services.Logging.ExceptionDiagnostics.Describe(exception));
            return [];
        }
